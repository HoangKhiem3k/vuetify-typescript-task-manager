...
<template>
    <form @submit.prevent="handleSubmit">
        <v-text-field v-model="request.description" :counter="10" :error-messages="description.errorMessage.value"
            label="Description" />
        ...
        <v-select v-model="request.priority" :items="priorities" label="Priority" />
